 ...
 * @group glegal
 */
class RegistrationTest extends glegalTestBase {
  ...
  /**
   * Test registration with default glegal seetings.
   */
  ...
  public function testScrollBoxCss() {
    ...
    $this->assertSession()->elementExists('css', '#user-register-form > div.glegal-terms-scroll');

    // Check scroll area contains full HTML version of T&Cs.
    $this->assertSession()->elementContains('css', '#user-register-form > div.glegal-terms-scroll', $this->conditions);
  }
  ...
  public function testHtml() {
    ...
    $this->assertSession()->elementContains('css', '#user-register-form > div.glegal-terms', $this->conditions);
  }
  ...
  public function testPageLink() {
    ...
    // Check link display.
    $this->assertSession()->elementExists('css', '#user-register-form > div.js-form-item.form-item.js-form-type-checkbox.form-type-checkbox.js-form-item-glegal-accept.form-item-glegal-accept > label > a');

    // Click the link.
    $this->click('#user-register-form > div.js-form-item.form-item.js-form-type-checkbox.form-type-checkbox.js-form-item-glegal-accept.form-item-glegal-accept > label > a');
